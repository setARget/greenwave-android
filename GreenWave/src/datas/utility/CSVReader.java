...
/**
 * A modified CSV Reader adapted to Kiceo application
...
public class CSVReader {
    ...
    public String[] readColumn(int idCol) throws IOException{
    	String[] tab;
    	ArrayList <String> column = new ArrayList<String>();
    	
    	while ((tab = readNext()) !=null && tab[0] != "") {
    		column.add(tab[idCol]);
    	}
